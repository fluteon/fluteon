  ...
  categories: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          name: 'Shirts',
          items: [
            { name: 'Formal Shirts', id: 'formal_shirts', href: '/women/shirts/formal_shirts' },
            { name: 'Satin Shirts', id: 'satin_shirts', href: '/women/shirts/satin_shirts' },
            { name: 'Hidden Button Shirts', id: 'hidden_button_shirts', href: '/women/shirts/hidden_button_shirts' },
          ],
        },
        {
          id: 'tops',
          name: 'Tops',
          items: [
            { name: 'Tanic Top', id: 'tanic_tops', href: '/women/tops/tanic_tops' },
            { name: 'Tank Top', id: 'tank_tops', href: '/women/tops/tank_tops' },
            { name: 'Peplum Top', id: 'peplum_tops', href: '/women/tops/peplum_tops' },
            { name: 'Crop Tops', id: 'crop_tops', href: '/women/tops/crop_tops' },
          ],
        },
        {
          id: 'kurtis',
          name: 'Kurtis',
          items: [
            { name: 'Office Wear', id: 'office_wear_kurtis', href: '/women/kurtis/office_wear_kurtis' },
            { name: 'A-Line Kurtis', id: 'a_line_kurtis', href: '/women/kurtis/a_line_kurtis' },
            { name: 'Kalamkari Kurti', id: 'kalamkari', href: '/women/kurtis/kalamkari' },
          ],
        },
      ],
    },
